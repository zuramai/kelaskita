  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          <a href="{{ route('admin.dashboard') }}"><img src="{{ Storage::url('/images/logo/'.config('web_config')['WEB_LOGO']) }}" alt="Logo" srcset="" /></a>
        </div>
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item  {{ 'admin.pickets.index' === Route::currentRouteName() ? 'active' : ''}} ">
