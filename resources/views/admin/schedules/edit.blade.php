                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('admin.schedules.store') }}" method="POST" class='mt-3' >
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="time" name="start_time" class='form-control  @error('start_time') is-invalid @enderror' value="{{$schedule->start_time}}">
                                                    @error('start_time')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="time" name="end_time" class='form-control  @error('end_time') is-invalid @enderror' value="{{$schedule->end_time}}">
                                                    @error('end_time')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
